...
(() => {
  ...
  const UI = {
    ...
    homeSinceNone:  { es: 'Aún nada: cuando el juego vuelva a guardar con algo nuevo (al sentarte en un banco), aquí verás lo que hayas conseguido.',
                      en: 'Nothing yet: when the game saves again with something new (when you sit on a bench), what you got shows here.' },
    ...
    homeConnectLead:{ es: 'Tu partida real, aquí: lo que te falta para el 112 %, dónde está en el mapa, tu sombra, el Diario del Cazador… y se pone al día mientras juegas.',
                      en: 'Your real game, here: what you are missing for 112%, where it is on the map, your shade, the Hunter\'s Journal… and it catches up while you play.' },
    homeStep1:      { es: 'Busca tu partida', en: 'Find your save' },
    homeStep1Text:  { es: 'en la carpeta del juego: user1.dat es la Partida 1.', en: 'in the game\'s folder: user1.dat is Save 1.' },
    homeStep2:      { es: 'Impórtala:', en: 'Import it:' },
    homeStep2Text:  { es: 'el 112 %, el mapa, el Diario, el Salón, tus amuletos y tu build, como en el juego.', en: 'the 112%, the map, the Journal, the Hall, your charms and your build, as in the game.' },
    homeStep3:      { es: 'Juega:', en: 'Play:' },
    homeStep3Text:  { es: 'con Chrome o Edge, cada vez que te sientas en un banco la web se pone al día sola.', en: 'with Chrome or Edge, every time you sit on a bench the site catches up by itself.' },
    homeStepPc:     { es: 'Desde el ordenador,', en: 'From a computer,' },
    homeStepPcText: { es: 'con Chrome o Edge, la web lee tu partida y la sigue mientras juegas.', en: 'with Chrome or Edge, the site reads your game and follows it while you play.' },
    homeStepPhone:  { es: 'En el móvil', en: 'On a phone' },
    homeStepPhoneText:{ es: 'puedes importar el archivo de tu partida si lo tienes a mano.', en: 'you can import your save\'s file if you have it with you.' },
    homeStepHand:   { es: 'O llévala a mano:', en: 'Or keep it by hand:' },
    homeStepHandText:{ es: 'marca jefes, amuletos y coleccionables a medida que los consigas.', en: 'mark bosses, charms and collectibles as you get them.' },
    homeByHandTitle:{ es: 'Llevarla a mano', en: 'Keep it by hand' },
    homeByHandText: { es: 'Empieza una partida vacía y marca lo que consigas en Progreso, el Mapa y el Diario.', en: 'Start an empty save and mark what you get in Progress, the Map and the Journal.' },
    homeBuildsTitle:{ es: 'Solo probar builds', en: 'Just try builds' },
    homeBuildsText: { es: 'Todo desbloqueado: cómo cambia cada stat con cada amuleto y cuántos golpes aguanta cada jefe.', en: 'Everything unlocked: how every stat changes with each charm, and how many hits each boss takes.' },
    homeBuildsGo:   { es: 'Abrir Amuletos →', en: 'Open Charms →' },
    ...
    equipmentTitle: { es: 'Equipo', en: 'Equipment' },
    ...
    pgCat_colosseum:{ es: 'Coliseo de los Insensatos', en: 'Colosseum of Fools' },
    pgCat_charms:   { es: 'Amuletos', en: 'Charms' },
    pgCat_equipment:{ es: 'Equipo', en: 'Equipment' },
    pgCat_spells:   { es: 'Hechizos', en: 'Spells' },
    pgCat_arts:     { es: 'Artes del aguijón', en: 'Nail Arts' },
    pgCat_masks:    { es: 'Fragmentos de máscara', en: 'Mask Shards' },
    pgCat_vessels:  { es: 'Fragmentos de vasija', en: 'Vessel Fragments' },
    pgCat_nail:     { es: 'Mejoras del aguijón', en: 'Nail Upgrades' },
    pgCat_dreamNail:{ es: 'Aguijón Onírico y esencia', en: 'Dream Nail and Essence' },
    pgCat_dreamers: { es: 'Soñadores', en: 'Dreamers' },
    pgCat_grimm:    { es: 'La compañía de Grimm', en: 'The Grimm Troupe' },
    ...
    shadeCard:      { es: 'Sombra en {area} · {geo} geo', en: 'Shade in {area} · {geo} geo' },
    impVersion:     { es: 'Guardada con la versión {v}', en: 'Saved with version {v}' },
    impMods:        { es: 'mods: {mods}', en: 'mods: {mods}' },
    itemsTitle:     { es: 'Objetos', en: 'Items' },
    relicsWorth:    { es: 'Lemm pagaría {geo} geo por tus reliquias', en: 'Lemm would pay {geo} geo for your relics' },
    bankNote:       { es: '+{geo} en el banco', en: '+{geo} in the bank' },
    countLess:      { es: '{what}: uno menos', en: '{what}: one less' },
    countMore:      { es: '{what}: uno más', en: '{what}: one more' },
    shardsNote:     { es: 'cuatro forman una máscara', en: 'four make a mask' },
    fragmentsNote:  { es: 'tres forman una vasija', en: 'three make a vessel' },
    ...
    hallMarkHint:   { es: 'Toca una dificultad para poner su símbolo en tu partida.', en: 'Tap a difficulty to put its symbol in your game.' },
    ...
    hallBulkSet:    { es: 'Marcar todas', en: 'Mark all' },
    hallBulkUnset:  { es: 'Quitar todas', en: 'Remove all' },
    hallBulkSetDiff:   { es: 'Marcar las {n} en {diff}', en: 'Mark all {n} on {diff}' },
    hallBulkUnsetDiff: { es: 'Quitar {diff} de las {n}', en: 'Remove {diff} from all {n}' },
    hallBulkRule:   { es: 'marcar Radiante marca también Ascendido, y quitar Ascendido quita Radiante',
                      en: 'marking Radiant also marks Ascended, and removing Ascended removes Radiant' },
    hallBulkDoneSet:     { es: '{diff}: {n} marcadas.', en: '{diff}: {n} marked.' },
    hallBulkDoneSetOne:  { es: '{diff}: 1 marcada.', en: '{diff}: 1 marked.' },
    hallBulkDoneUnset:   { es: '{diff}: {n} quitadas.', en: '{diff}: {n} removed.' },
    hallBulkDoneUnsetOne:{ es: '{diff}: 1 quitada.', en: '{diff}: 1 removed.' },
    hallUndo:       { es: 'Deshacer', en: 'Undo' },
    hallColGame:    { es: 'En tu partida', en: 'In your game' },
    ...
    runBosses:      { es: '{n} jefes', en: '{n} bosses' },
    runBossesLeft:  { es: 'Quedan {n} de {total} jefes', en: '{n} of {total} bosses left' },
    ...
    runPathTitle:   { es: 'El recorrido', en: 'The way through' },
    runPathHint:    { es: 'toca una sala para entrar directo en ella', en: 'tap a room to enter straight into it' },
    runStartAtTip:  { es: 'Entrar en {room}', en: 'Enter at {room}' },
