...
(() => {
  ...
  const UI = {
    ...
    homeConnectLine:{ es: 'Importa tu partida y, con Chrome o Edge, se pone al día sola cada vez que te sientas en un banco.',
                      en: 'Import your game and, with Chrome or Edge, it catches up by itself every time you sit on a bench.' },
    homeConnectLineFile:{ es: 'Importa el archivo de tu partida y verás aquí todo lo que te falta.',
                      en: 'Import your save\'s file and see here everything you are missing.' },
    homeDrop:       { es: 'o suelta aquí tu user1.dat', en: 'or drop your user1.dat here' },
    homeExample:    { es: 'Ejemplo', en: 'Example' },
    homeFeatPct:    { es: 'Lo que te falta para el 112 %', en: 'What you are missing for 112%' },
