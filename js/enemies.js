/* js/enemies.js — Hollow Knight's enemies and bosses, for the simulator.
   Source: kb/ (which in turn comes from hollowknight.wiki in September 2026):
     · health and area        kb/data/hp.json and kb/data/entities.json. A common enemy's area
                              is the first place its wiki page's «Location» section names, as the
                              region of the game's map it belongs to (the Mantis Village, the
                              Fungal Wastes; the Distant Village, Deepnest), September 2026.
                              Bluggsac and Lifeseed turn up all over the kingdom: "Hallownest".
                              What Grey Prince Zote summons takes his area (Dirtmouth); the
                              Zotelings of the Eternal Ordeal, Godhome's.
...
(() => {
  ...
  { id: 'grimmkin-novice', kind: 'boss', name: { es: 'Grimario Novato', en: 'Grimmkin Novice' },
    zone: { es: 'Sendero Verde', en: 'Greenpath' }, hp: [50, 90, 120, 140, 160], at: null, asra: null, dmg: 1,
    attacks: [
      { es: 'Carga', en: 'Charge' },
  ...
  { id: 'grimmkin-master', kind: 'boss', name: { es: 'Grimario Maestro', en: 'Grimmkin Master' },
    zone: { es: 'Bocasucia', en: 'Dirtmouth' }, hp: [75, 120, 180, 210, 240], at: null, asra: null, dmg: 1,
    attacks: [
      { es: 'Carga', en: 'Charge' },
      { es: 'Rociada de llamas', en: 'Flame Spray', proj: 'pierce' },
      { es: 'Espiral de llamas', en: 'Flame Spiral', proj: 'pierce' },
  ...
  { id: 'grimmkin-nightmare', kind: 'boss', name: { es: 'Grimario Pesadilla', en: 'Grimmkin Nightmare' },
    zone: { es: 'Páramos Fúngicos', en: 'Fungal Wastes' }, hp: [100, 180, 240, 280, 320], at: null, asra: null, dmg: 2,
    attacks: [
      { es: 'Carga', en: 'Charge' },
      { es: 'Rociada de llamas', en: 'Flame Spray', proj: 'pierce' },
      { es: 'Espiral de llamas', en: 'Flame Spiral', proj: 'pierce' },
  ...
  { id: 'ambloom', kind: 'enemy', name: { es: 'Ambloom', en: 'Ambloom' },
    zone: { es: 'Páramos Fúngicos', en: 'Fungal Wastes' }, hp: 12, dmg: 1 },
  { id: 'armoured-squit', kind: 'enemy', name: { es: 'Mosquito blindado', en: 'Armoured Squit' },
    zone: { es: 'Coliseo de los Insensatos', en: 'Colosseum of Fools' }, hp: 40, dmg: 1 },
  { id: 'aspid-hatchling', kind: 'enemy', name: { es: 'Cría aspid', en: 'Aspid Hatchling' },
    zone: { es: 'Cruces Olvidados', en: 'Forgotten Crossroads' }, hp: 5, dmg: 1 },
  { id: 'aspid-hunter', kind: 'enemy', name: { es: 'Cazador aspid', en: 'Aspid Hunter' },
    zone: { es: 'Cruces Olvidados', en: 'Forgotten Crossroads' }, hp: 15, dmg: 1 },
  { id: 'aspid-mother', kind: 'enemy', name: { es: 'Madre aspid', en: 'Aspid Mother' },
    zone: { es: 'Cruces Olvidados', en: 'Forgotten Crossroads' }, hp: 20, dmg: 1,
    summons: [
  ...
  { id: 'battle-obble', kind: 'enemy', name: { es: 'Obble de guerra', en: 'Battle Obble' },
    zone: { es: 'Coliseo de los Insensatos', en: 'Colosseum of Fools' }, hp: 70, dmg: 1 },
  { id: 'belfly', kind: 'enemy', name: { es: 'Barrílula', en: 'Belfly' },
    zone: { es: 'Canales Reales', en: 'Royal Waterways' }, hp: 5, dmg: 1 },
  ...
  { id: 'boofly', kind: 'enemy', name: { es: 'Bubélula', en: 'Boofly' },
    zone: { es: 'Límite del Reino', en: 'Kingdom’s Edge' }, hp: 40, dmg: 1 },
  { id: 'carver-hatcher', kind: 'enemy', name: { es: 'Eclosionador cavador', en: 'Carver Hatcher' },
    zone: { es: 'Nido Profundo', en: 'Deepnest' }, hp: 35, dmg: 1,
    summons: [
  ...
  { id: 'entombed-husk', kind: 'enemy', name: { es: 'Restos sepultados', en: 'Entombed Husk' },
    zone: { es: 'Tierras de Reposo', en: 'Resting Grounds' }, hp: 45, dmg: 1 },
  { id: 'fluke-larva', kind: 'enemy', name: { es: 'Fluke Larva', en: 'Fluke Larva' },
    zone: { es: 'Canales Reales', en: 'Royal Waterways' }, hp: 1, dmg: 1 },
  { id: 'flukefey', kind: 'enemy', name: { es: 'Tremacría', en: 'Flukefey' },
    zone: { es: 'Canales Reales', en: 'Royal Waterways' }, hp: 13, dmg: 1 },
  { id: 'flukemon', kind: 'enemy', name: { es: 'Tremadora', en: 'Flukemon' },
    zone: { es: 'Canales Reales', en: 'Royal Waterways' }, hp: 55, dmg: 1,
  ...
  { id: 'folly', kind: 'enemy', name: { es: 'Folly', en: 'Folly' },
    zone: { es: 'Santuario de Almas', en: 'Soul Sanctum' }, hp: 13, dmg: 1 },
  { id: 'fool-eater', kind: 'enemy', name: { es: 'Engulletontos', en: 'Fool Eater' },
    zone: { es: 'Sendero Verde', en: 'Greenpath' }, hp: 16, dmg: 1 },
  { id: 'fungified-husk', kind: 'enemy', name: { es: 'Restos fungificados', en: 'Fungified Husk' },
    zone: { es: 'Páramos Fúngicos', en: 'Fungal Wastes' }, hp: 15, dmg: 1 },
  { id: 'fungling', kind: 'enemy', name: { es: 'Fungicría', en: 'Fungling' },
    zone: { es: 'Páramos Fúngicos', en: 'Fungal Wastes' }, hp: 10, dmg: 1 },
  ...
  { id: 'furious-vengefly', kind: 'enemy', name: { es: 'Vengamosca colérica', en: 'Furious Vengefly' },
    zone: { es: 'Cruces Olvidados', en: 'Forgotten Crossroads' }, hp: 40, dmg: 1 },
  { id: 'garpede', kind: 'enemy', name: { es: 'Garpiés', en: 'Garpede' },
    zone: { es: 'Nido Profundo', en: 'Deepnest' }, hp: null, dmg: 1 },
  ...
  { id: 'husk-guard', kind: 'enemy', name: { es: 'Cáscara guardiana', en: 'Husk Guard' },
    zone: { es: 'Cruces Olvidados', en: 'Forgotten Crossroads' }, hp: 70, dmg: 1 },
  { id: 'husk-hive', kind: 'enemy', name: { es: 'Cáscara de colmena', en: 'Husk Hive' },
    zone: { es: 'La Colmena', en: 'The Hive' }, hp: 60, dmg: 1,
    summons: [
  ...
  { id: 'lesser-mawlek', kind: 'enemy', name: { es: 'Mawlek inferior', en: 'Lesser Mawlek' },
    zone: { es: 'Cuenca Antigua', en: 'Ancient Basin' }, hp: 60, dmg: 1 },
  ...
  { id: 'lightseed', kind: 'enemy', name: { es: 'Germen de luz', en: 'Lightseed' },
    zone: { es: 'Cuenca Antigua', en: 'Ancient Basin' }, hp: 1, dmg: 1 },
  { id: 'little-weaver', kind: 'enemy', name: { es: 'Minitejedora', en: 'Little Weaver' },
    zone: { es: 'Nido Profundo', en: 'Deepnest' }, hp: 30, dmg: 1 },
  { id: 'loodle', kind: 'enemy', name: { es: 'Loodle', en: 'Loodle' },
    zone: { es: 'Jardines de la Reina', en: 'Queen’s Gardens' }, hp: 30, dmg: 1 },
  { id: 'maggot', kind: 'enemy', name: { es: 'Gusano', en: 'Maggot' },
    zone: { es: 'Cruces Olvidados', en: 'Forgotten Crossroads' }, hp: 1, dmg: 1 },
  { id: 'mantis-petra', kind: 'enemy', name: { es: 'Petramantis', en: 'Mantis Petra' },
    zone: { es: 'Jardines de la Reina', en: 'Queen’s Gardens' }, hp: 45, dmg: 1 },
  { id: 'mantis-traitor', kind: 'enemy', name: { es: 'Traidor mantis', en: 'Mantis Traitor' },
    zone: { es: 'Jardines de la Reina', en: 'Queen’s Gardens' }, hp: 74, dmg: 1 },
  { id: 'mantis-warrior', kind: 'enemy', name: { es: 'Guerrero mantis', en: 'Mantis Warrior' },
    zone: { es: 'Páramos Fúngicos', en: 'Fungal Wastes' }, hp: 20, dmg: 1 },
  ...
  { id: 'mawlurk', kind: 'enemy', name: { es: 'Mawlurk', en: 'Mawlurk' },
    zone: { es: 'Cuenca Antigua', en: 'Ancient Basin' }, hp: 135, dmg: 1 },
  ...
  { id: 'sharp-baldur', kind: 'enemy', name: { es: 'Baldur espinado', en: 'Sharp Baldur' },
    zone: { es: 'Coliseo de los Insensatos', en: 'Colosseum of Fools' }, hp: 65, dmg: 1 },
  ...
  { id: 'shrumal-ogre', kind: 'enemy', name: { es: 'Fungiogro', en: 'Shrumal Ogre' },
    zone: { es: 'Páramos Fúngicos', en: 'Fungal Wastes' }, hp: 80, dmg: 1 },
  ...
  { id: 'vengefly', kind: 'enemy', name: { es: 'Vengamosca', en: 'Vengefly' },
    zone: { es: 'Acantilados Aulladores', en: 'Howling Cliffs' }, hp: 8, dmg: 1 },
  ...
  { id: 'void-tendrils', kind: 'enemy', void: true, name: { es: 'Tentáculos del vacío', en: 'Void Tendrils' },
    zone: { es: 'El Abismo', en: 'The Abyss' }, /* ABYSS_DEEP */ hp: null, dmg: 2 },
  ...
  { id: 'wingmould', kind: 'enemy', name: { es: 'Carcasa alada', en: 'Wingmould' },
    zone: { es: 'Palacio Blanco', en: 'White Palace' }, /* WHITE_PALACE */ hp: null, dmg: 1 },
  { id: 'winged-zoteling', kind: 'enemy', name: { es: 'Zotito Alado', en: 'Winged Zoteling' },
    zone: { es: 'Bocasucia', en: 'Dirtmouth' }, hp: 20, dmg: 1 },
